# Хотим скачать тексты с сайта и разложить их сразу по директориям согласно рубрикам.
# Изучив сайт, увидели возможность получить все ссылки на тексты с одной странички, кладем эти ссылки в список.
# Потом проходимся по этому списку, вычленяя рубрики и сами названия текстов из ссылок.
# Не будем скачивать вложения второго уровня (тексты в нескольких файлах-частях), они длинные и их немного, не хотим вносить перекос.
